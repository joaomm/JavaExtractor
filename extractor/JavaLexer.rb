# JavaLexer (Java.g)
# Generated by ANTLR 3.0.1 on 2010-01-19 15:16:28
...
class JavaLexer
    ...
    def match_WS()
    		...
    		if !matchedOnce1
    		    raise "Expected at least one match: 421:6: ( '\\n' | '\\t' | '\\r' | ' ' )+"
    		end
    		 @channel = 99 
    end
    ...
    def match_IDENTIFIER()
    		...
    		@type = :IDENTIFIER
    		@type_int = IDENTIFIER
    		# 494:5: INITIAL_LETTER ( PARTIAL_LETTER )*
    		match_INITIAL_LETTER()
    		# 494:20: ( PARTIAL_LETTER )*
    		while true
    		    alt3 = 2
    		    # ()* loopback of 494:20: ( PARTIAL_LETTER )*
