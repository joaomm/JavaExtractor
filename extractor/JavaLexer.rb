# JavaLexer (Java.g)
# Generated by ANTLR 3.0.1 on 2010-01-18 12:36:20
...
class JavaLexer
    ...
    def match_WS()
    		...
    		if !matchedOnce1
    		    raise "Expected at least one match: 409:6: ( '\\n' | '\\t' | '\\r' | ' ' )+"
    		end
    		 @channel = 99 
    end
    ...
    def match_IDENTIFIER()
    		...
    		@type = :IDENTIFIER
    		@type_int = IDENTIFIER
    		# 482:5: INITIAL_LETTER ( PARTIAL_LETTER )*
    		match_INITIAL_LETTER()
    		# 482:20: ( PARTIAL_LETTER )*
    		while true
    		    alt3 = 2
    		    # ()* loopback of 482:20: ( PARTIAL_LETTER )*
